using System;
using static Roto.Core.EntityContext;
using static Roto.Core.LanguageID;
using G3GC = Roto.Core.StringFont3GC;
using G5 = Roto.Core.StringFont5;
using G6 = Roto.Core.StringFont6;
using G7 = Roto.Core.StringFont7;
using G8 = Roto.Core.StringFont8;
using G8a = Roto.Core.StringFont8a;
using G8b = Roto.Core.StringFont8b;
