...
using Roto.Core;
using RotoDex.Desktop.Controls;
...
public static class DevUtil
{
    ...
    private static void UpdateTranslations()
    {
        ...
        WinFormsTranslator.LoadSettings<RotoDexSettings>(DefaultLanguage);
        ...
        var dir = GetResourcePath("RotoDex.WinForms", "Resources", "text");
    ...
    private static void DumpStringsMessage() => DumpStrings(typeof(MessageStrings), false, "RotoDex.Core", "Resources", "text", "program");
    private static void DumpStringsLegality()
    {
        ReadOnlySpan<string> rel = ["RotoDex.Core", "Resources", "localize"];
