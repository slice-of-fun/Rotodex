...
using static Roto.Core.MessageStrings;
...
public partial class Main : Form
{
    ...
    public static RotoDexSettings Settings => Program.Settings;
    ...
    private void ReloadProgramSettings(RotoDexSettings settings, bool skipCore = false)
    {
        if (!skipCore)
    ...
    private async void Main_FormClosing(object sender, FormClosingEventArgs e)
    {
        try
        {
            ...
            await RotoDexSettings.SaveSettings(Program.PathConfig, Settings).ConfigureAwait(false);
        }
        catch
        {
